...
export const AuthToken = {
  ...
  generateRefreshToken: async (user: UserDTO) =>
    sign({ user }, process.env.JWT_REFRESH_TOKEN_SECRET as Secret, {
      expiresIn: process.env.JWT_REFRESH_TOKEN_EXPIRE,
    }),

  generateRandomToken: async (data: any) =>
    sign({ data }, process.env.JWT_RANDOM_TOKEN_SECRET as Secret, {
